...
var configFile = flag.String("f", "etc/publiccontent.yaml", "the config file")
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		publicContentRpc.RegisterPublicContentServiceServer(grpcServer, server.NewPublicContentServiceServer(ctx))
